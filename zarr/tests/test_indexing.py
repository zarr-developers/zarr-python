...
def _test_orthogonal_indexing_1d_common(a, z, ix):
    expect = a[ix]
...
def test_orthogonal_indexing_1d_bool():
    ...
    for p in 0.5, 0.1, 0.01:
        ...
        _test_orthogonal_indexing_1d_common(a, z, ix)
...
# noinspection PyStatementEffect
def test_orthogonal_indexing_1d_int():
...
def test_orthogonal_indexing_1d_slice_with_step():
...
def _test_orthogonal_indexing_2d_common(a, z, ix0, ix1):
...
def test_orthogonal_indexing_2d_bool():
    ...
    for p in 0.5, 0.1, 0.01:
        ...
        # main tests
        _test_orthogonal_indexing_2d_common(a, z, ix0, ix1)
...
def test_orthogonal_indexing_2d_int():
...
def _test_orthogonal_indexing_3d_common(a, z, ix0, ix1, ix2):
...
def test_orthogonal_indexing_3d_bool():
    ...
    for p in 0.5, 0.1, 0.01:
        ...
        _test_orthogonal_indexing_3d_common(a, z, ix0, ix1, ix2)
...
def test_orthogonal_indexing_3d_int():
...
def _test_orthogonal_indexing_1d_common_set(v, a, z, ix):
    a[:] = 0
    a[ix] = v[ix]
    z[:] = 0
    z.oindex[ix] = v[ix]
...
def test_orthogonal_indexing_1d_bool_set():
    ...
    for p in 0.5, 0.1, 0.01:
        ix = np.random.binomial(1, p, size=a.shape[0]).astype(bool)
        _test_orthogonal_indexing_1d_common_set(v, a, z, ix)


def test_orthogonal_indexing_1d_int_set():
...
def _test_orthogonal_indexing_2d_common_set(v, a, z, ix0, ix1):
...
def test_orthogonal_indexing_2d_bool_set():
    ...
    for p in 0.5, 0.1, 0.01:
        ix0 = np.random.binomial(1, p, size=a.shape[0]).astype(bool)
        ix1 = np.random.binomial(1, .5, size=a.shape[1]).astype(bool)
        _test_orthogonal_indexing_2d_common_set(v, a, z, ix0, ix1)


def test_orthogonal_indexing_2d_int_set():
...
def _test_orthogonal_indexing_3d_common_set(v, a, z, ix0, ix1, ix2):
...
def test_orthogonal_indexing_3d_bool_set():
    ...
    for p in 0.5, 0.1, 0.01:
        ...
        ix1 = np.random.binomial(1, .5, size=a.shape[1]).astype(bool)
        ix2 = np.random.binomial(1, .5, size=a.shape[2]).astype(bool)
        _test_orthogonal_indexing_3d_common_set(v, a, z, ix0, ix1, ix2)


def test_orthogonal_indexing_3d_int_set():
...
# noinspection PyStatementEffect
def test_coordinate_indexing_1d():
...
def test_coordinate_indexing_2d():
