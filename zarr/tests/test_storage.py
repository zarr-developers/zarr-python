...
def test_format_compatibility():
    ...
    arrays_chunks = [
        (np.arange(2000, dtype='i1'), 100),
        (np.arange(2000, dtype='i2'), 100),
        (np.arange(2000, dtype='i4'), 100),
        (np.arange(2000, dtype='i8'), 1000),
        (np.random.randint(0, 200, size=3333, dtype='u1'), 100),
        (np.random.randint(0, 2000, size=3333, dtype='u2'), 100),
        (np.random.randint(0, 2000, size=3333, dtype='u4'), 100),
        (np.random.randint(0, 2000, size=3333, dtype='u8'), 100),
        (np.linspace(0, 1, 2000, dtype='f2'), 100),
        (np.linspace(0, 1, 2000, dtype='f4'), 100),
        (np.linspace(0, 1, 2000, dtype='f8'), 100),
        (np.random.normal(loc=0, scale=1, size=3333).astype('f2'), 100),
        (np.random.normal(loc=0, scale=1, size=3333).astype('f4'), 100),
        (np.random.normal(loc=0, scale=1, size=3333).astype('f8'), 100),
