...
class AsyncGroup:
    ...
    async def empty(self, *, name: str, shape: ChunkCoords, **kwargs: Any) -> AnyAsyncArray:
    ...
    async def zeros(self, *, name: str, shape: ChunkCoords, **kwargs: Any) -> AnyAsyncArray:
    ...
    async def ones(self, *, name: str, shape: ChunkCoords, **kwargs: Any) -> AnyAsyncArray:
...
class Group(SyncMixin):
    ...
    def create(self, *args: Any, **kwargs: Any) -> AnyArray:
        # Backwards compatibility for 2.x
    ...
    def empty(self, *, name: str, shape: ChunkCoords, **kwargs: Any) -> AnyArray:
    ...
    def zeros(self, *, name: str, shape: ChunkCoords, **kwargs: Any) -> AnyArray:
        """Create an array, with zero being used as the default value for uninitialized portions of the array.
    ...
    def ones(self, *, name: str, shape: ChunkCoords, **kwargs: Any) -> AnyArray:
        """Create an array, with one being used as the default value for uninitialized portions of the array.
