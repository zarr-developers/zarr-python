...
class ArrayV2:
    ...
    async def create_async(
        ...
        *,
        ...
        fill_value: None | int | float | None = None,
        order: Literal["C", "F"] = "C",
    ...
    async def _decode_chunk(self, chunk_bytes: BytesLike | None) -> np.ndarray | None:
    ...
    async def _encode_chunk(self, chunk_array: np.ndarray) -> BytesLike | None:
