...
redirects = {
     ...
     "docs/spec/v1": 'https://zarr-specs.readthedocs.io/en/latest/v1/v1.0.html',
     "docs/spec/v2": "https://zarr-specs.readthedocs.io/en/latest/v2/v2.0.html",
     "docs/spec/v3": "https://zarr-specs.readthedocs.io/en/latest/v3/core/v3.0.html",
}
