"""Validate raw-bytes (`r<N>`) fill-value fixtures."""
...
from zarr_metadata.v3.data_type.raw import RawBytesFillValue
...
def test_fill_value(case: object) -> None:
    TypeAdapter(RawBytesFillValue).validate_python(case)
