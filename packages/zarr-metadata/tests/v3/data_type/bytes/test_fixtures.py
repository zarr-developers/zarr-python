"""Validate variable-length bytes fill-value fixtures."""
...
from zarr_metadata.v3.data_type.bytes import BytesFillValue
...
def test_fill_value(case: object) -> None:
    TypeAdapter(BytesFillValue).validate_python(case)
