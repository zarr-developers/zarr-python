...
those parts — a shard's inner chunk shape must divide *every* chunk it
...
An unmodelled codec in front of a sharding codec — every `numcodecs.*`
filter is one — silenced the whole shard interior: its inner pipeline and
