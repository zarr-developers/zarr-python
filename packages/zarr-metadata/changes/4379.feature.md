...
documents. The package now models metadata in two layers with one
...
are defined; rules about a particular codec, chunk grid, or data type live with that entity under
