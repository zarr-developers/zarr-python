...
from zarr_storage.legacy._utils import _normalize_byte_range_index
from zarr_storage.testing.utils import assert_bytes_equal

__all__ = ["LatencyStore", "StoreTests"]
...
class StoreTests[S: Store, B: Buffer]:
    ...
    def _require_get_sync(store: S) -> SupportsGetSync:
        """Skip unless *store* implements [`SupportsGetSync`][zarr_storage.legacy._abc.SupportsGetSync]."""
    ...
    def _require_set_sync(store: S) -> SupportsSetSync:
        """Skip unless *store* implements [`SupportsSetSync`][zarr_storage.legacy._abc.SupportsSetSync]."""
    ...
    def _require_delete_sync(store: S) -> SupportsDeleteSync:
        """Skip unless *store* implements [`SupportsDeleteSync`][zarr_storage.legacy._abc.SupportsDeleteSync]."""
