...
from zarr_storage.legacy import MemoryStore
from zarr_storage.legacy._abc import RangeByteRequest, Store, SuffixByteRequest
from zarr_storage.legacy.experimental.cache_store import CacheStore
...
def test_cache_store_opts_out_of_sync_io() -> None:
    ...
    """
    from zarr_storage.legacy import MemoryStore
    from zarr_storage.legacy._abc import _store_supports_sync_io
