...
class TestAttributes:
    ...
    def test_caching_on(self, zarr_version):
        ...
        assert store.counter["__getitem__", attrs_key] == 0
        assert store.counter["__setitem__", attrs_key] == 0
        if zarr_version == 2:
        ...
        assert store.counter["__getitem__", attrs_key] == 0
        assert store.counter["__setitem__", attrs_key] == 1
        ...
        assert a["foo"] == "xxx"
        assert store.counter["__getitem__", attrs_key] == 1
        assert a["bar"] == 42
        assert store.counter["__getitem__", attrs_key] == 1
        assert a["foo"] == "xxx"
        assert store.counter["__getitem__", attrs_key] == 1
        ...
        assert store.counter["__setitem__", attrs_key] == 2
        assert a["foo"] == "yyy"
        assert get_cnt == store.counter["__getitem__", attrs_key]
        assert store.counter["__setitem__", attrs_key] == 2
        ...
        assert get_cnt == store.counter["__getitem__", attrs_key]
        assert store.counter["__setitem__", attrs_key] == 3
        assert a["foo"] == "zzz"
        assert a["bar"] == 84
        assert get_cnt == store.counter["__getitem__", attrs_key]
        assert store.counter["__setitem__", attrs_key] == 3
        ...
        assert get_cnt == store.counter["__getitem__", attrs_key]
        assert store.counter["__setitem__", attrs_key] == 4
        assert "bar" not in a
        assert get_cnt == store.counter["__getitem__", attrs_key]
        assert store.counter["__setitem__", attrs_key] == 4
    ...
    def test_caching_off(self, zarr_version):
        ...
        assert store.counter["__getitem__", attrs_key] == 1
        assert a["bar"] == 42
        assert store.counter["__getitem__", attrs_key] == 2
        assert a["foo"] == "xxx"
        assert store.counter["__getitem__", attrs_key] == 3
